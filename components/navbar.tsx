          ...
          <div className="relative rounded-2xl bg-gradient-to-br from-lime-500/5 to-yellow-500/5 backdrop-blur-md border border-lime-500/10 shadow-lg shadow-lime-500/5 px-4 md:px-6 py-3 md:py-4">
            ...
            <div className="flex items-center justify-between relative z-10">
              ...
              <div className="hidden md:flex items-center gap-3">
                {/* WhatsApp Button dengan desain premium */}
                <a
                  href="https://wa.me/+6281234701212"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="relative group px-4 py-2 bg-gradient-to-r from-[#25D366]/10 to-[#128C7E]/10 border border-[#25D366]/30 rounded-full overflow-hidden hover:shadow-lg hover:shadow-[#25D366]/25 transition-all duration-500 hover:scale-105"
                >
                  {/* Efek shine (seperti tombol CONTACT sebelumnya) */}
                  <span className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />

                  {/* Konten: logo WhatsApp + teks (opsional) */}
                  <span className="relative z-10 flex items-center gap-2 text-sm font-medium">
                    ...
                    />
                    <span className="hidden sm:inline text-background text-white">
                      WhatsApp
                    </span>
                  </span>

                  {/* Tooltip yang muncul saat hover (mirip dengan social icon di ContactSection) */}
                  <span className="absolute -top-10 left-1/2 -translate-x-1/2 px-2 py-1 bg-background border border-[#25D366]/30 rounded-full text-xs font-medium text-[#25D366] opacity-0 group-hover:opacity-100 transition-all duration-300 whitespace-nowrap pointer-events-none">
                    Chat via WhatsApp
                  </span>
                </a>
              </div>
