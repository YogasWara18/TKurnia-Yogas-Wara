...
import { ExternalLink, Github, Calendar, Tag, ChevronRight } from "lucide-react";
...
const webProjects = [
  {
    title: "Oceanis Grand Palace  – Full Frontend build with React + Vite + JavaScript + TailwindCss",
    description: "Oceanis Grand Palace is a luxury hotel website designed to deliver a premium experience with an elegant and cinematic atmosphere. It highlights exclusive services such as Dive & Discovery, Night of Elegance, Sunset Wellness, and Luxury Water Sports, alongside world-class facilities including a pristine beachfront, infinity pool oasis, fine dining excellence, exclusive spa retreat, and a grand ballroom for events. Guests can explore a wide range of room options, from the Ocean View Chamber to the Presidential Suite, each presented with detailed capacity, size, and pricing. The site also emphasizes the grandeur of its architecture, exclusive suites, harmony with the ocean, and world-class culinary offerings. Complementing this, the blog and reviews section features refined articles on travel, wellness, gastronomy, and guest experiences that underscore prestige and unforgettable memories. Finally, the contact and location details, based in Medan, North Sumatra, Indonesia, provide clear information for reservations and communication, making the website a seamless gateway to luxury hospitality.",
    video: "/Thumbnail-Oceanis.mp4",
    tags: ["Design", "Website Hotel", "Animation", "Development", "Branding", "Responsive", "Vite", "React", "Javascript", "TailwindCss", "Swiper.js", "RestAPI", "Vercel"],
    liveUrl: "https://oceanis-grand-palace.vercel.app/",
    githubUrl: "https://github.com/YogasWara18/Oceanis-Grand-Palace",
    date: "February 2026",
  },
  {
    title: "indoShop E-Commerce – Full Frontend build with React + Next.js + TypeScript + TailwindCss",
    description: "Indoshop Art Market is an e-commerce platform designed to help Indonesian artisans modernize artworks from every region through an elegant, responsive, and easily accessible digital display; this website is built using modern technologies such as React.js for interactive interfaces, Next.js for SEO optimization and fast rendering, TypeScript to maintain code consistency, TailwindCSS for responsive styling, Swiper.js for dynamic product sliders, and an authentication system that ensures user security and personalization, so that every piece of Indonesian art can be presented professionally and reach the global market.",
    video: "/Thumbnail-indoShop.mp4",
    tags: ["Design", "E-Commerce", "Animation", "Development", "Branding", "Responsive", "Next.js", "React", "TypeScript", "TailwindCss", "Swiper.js", "RestAPI", "Vercel"],
  ...
  },
  {
    ...
    description: "The Burger Café Bar website is a professional frontend project showcasing culinary branding with a modern, interactive, and high performance approach. Built using Next.js as the primary framework and Bootstrap for its grid system and responsive components, the website delivers a clean and consistent appearance across multiple devices.",
    video: "/Thumbnail-Burger.mp4",
    tags: ["Design", "Animation", "Development", "Branding", "Responsive", "Next.js", "React", "TypeScript", "Bootstrap", "RestAPI", "Vercel"],
  ...
  },
  {
    ...
    description: "This website is built using Next.js for its fast and scalable React architecture, combined with GSAP for smooth, interactive animations. Styling is handled with TailwindCSS for responsiveness and consistency, while JavaScript and additional components deliver an elegant, modern, and extensible UI/UX experience.",
    video: "/Thumbnail-video-JackDaniel's.mp4",
    tags: ["Design", "Animation", "Development", "Branding", "Responsive", "Next.js", "React", "JavaScript", "TailwindCSS", "GSAP", "Vercel"],
...
const systemProjects = [
  ...
  },
  {
    ...
    description: "Educational platform for managing student records, attendance, grades, and parent-teacher communication. Includes modules for student enrollment, class scheduling, exam management, and report card generation. Built with Laravel PHP framework, MySQL database, and Bootstrap for responsive interface design.",
    video: "/Thumbnail-School.mp4",
    tags: ["System Development", "Education", "Laravel", "PHP", "MySQL", "Bootstrap", "Dashboard"],
  ...
  },
  {
    ...
    description: "Advanced inventory tracking system with barcode scanning, low stock alerts, purchase orders, and supplier management. Features real-time stock updates, multi-warehouse support, and detailed inventory reports. Built with MongoDB, Express.js, React with Redux for state management, and Node.js backend.",
    video: "/Thumbnail-Inventory.mp4",
    tags: ["System Development", "Inventory", "MERN", "MongoDB", "Express", "React", "Node.js", "Redux"],
...
const wordpressProjects = [
  {
    ...
    description: "Bespoke WordPress theme for a luxury beach resort. Features custom post types for rooms and amenities, advanced booking system integrated with WooCommerce, multilingual support with WPML, and optimized for speed with lazy loading and caching plugins. The design focuses on visual storytelling with full-screen galleries and immersive video backgrounds.",
    video: "/Thumbnail-WP-Resort.mp4",
    tags: ["WordPress", "Custom Theme", "PHP", "WooCommerce", "WPML", "ACF", "Booking System", "SEO"],
  ...
  },
  {
    ...
    description: "High-performance news portal with custom theme development. Features include multi-author support, frontend submission forms, ad management system, and optimized for Core Web Vitals. Integrated with Google AdSense, newsletter subscriptions via Mailchimp, and advanced caching for high traffic handling.",
    video: "/Thumbnail-WP-News.mp4",
    tags: ["WordPress", "News Portal", "Custom Theme", "ACF", "Multi-author", "Ad Management", "Performance"],
    liveUrl: "https://newsportal.demo",
    githubUrl: "https://github.com/YogasWara18/wp-news-portal",
    date: "January 2026",
  },
  {
    title: "Real Estate Listing Platform – Custom Post Types + Maps Integration",
    description: "Comprehensive real estate website with custom property listings. Features advanced search with filters for price, location, bedrooms, and amenities. Integrated with Google Maps for property locations, mortgage calculator, and agent profiles. Built with custom post types, Advanced Custom Fields, and optimized for local SEO.",
    video: "/Thumbnail-WP-RealEstate.mp4",
    tags: ["WordPress", "Real Estate", "Custom Post Types", "Google Maps API", "ACF", "Property Listings"],
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (sectionRef.current) {
        const particles = sectionRef.current.querySelectorAll('.project-particle');
        gsap.to(particles, {
          y: -150,
          rotation: 360,
          duration: 25,
      ...
      <div className="container relative z-10 px-4 sm:px-6">
        ...
        <div ref={titleRef} className="text-center mb-16 md:mb-20">
          ...
          <div className="overflow-hidden">
            <h2 className="title-line text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-lime-500/60 italic">
              {subtitle}
            </h2>
          </div>
            ...
            >
              ...
              >
                <div className="video-container relative aspect-video md:aspect-4/3 overflow-hidden bg-black/50 rounded-2xl md:rounded-3xl border border-lime-500/20">
                  ...
                  {/* Badges */}
                  <div className="absolute top-2 left-2 md:top-4 md:left-4 glass px-2 py-1 md:px-3 md:py-1.5 rounded-full">
                    <span className="text-[10px] md:text-xs font-medium text-lime-500 flex items-center gap-1">
                      <Tag className="w-2 h-2 md:w-3 md:h-3" />
                      <span className="hidden xs:inline">{project.tags[0]}</span>
                      <span className="xs:hidden">{project.tags[0].substring(0, 3)}</span>
                    </span>
                  </div>
                  ...
                  <div className="absolute bottom-2 right-2 md:bottom-4 md:right-4 glass px-2 py-1 md:px-3 md:py-1.5 rounded-full">
                    <span className="text-[10px] md:text-xs font-medium text-yellow-500 flex items-center gap-1">
                      ...
                      <span className="hidden xs:inline">{project.date}</span>
                      <span className="xs:hidden">{project.date.split(' ')[0]}</span>
                    </span>
                  </div>
                </div>
              </div>
              ...
              {/* Content Section */}
              <div className={`w-full order-2 ${projectIndex % 2 === 1 ? "md:order-1" : ""}`}>
                <div className="space-y-4 md:space-y-6 text-center md:text-left">
                  ...
                  {/* Title */}
                  <div className="overflow-hidden">
                    <h3 className="content-animate text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-tight bg-gradient-to-r from-lime-500 to-yellow-500 bg-clip-text text-transparent">
                      {project.title}
                    </h3>
                  </div>
        ...
        <div className="text-center mt-16 md:mt-20">
          ...
          >
            <span className="text-sm md:text-base text-foreground font-medium">View All Projects</span>
